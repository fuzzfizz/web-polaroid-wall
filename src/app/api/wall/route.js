...
export async function POST(request) {
  try {
    ...
    if (!team_name || !member1_name || !member1_student_id || !member2_name || !member2_student_id) {
    ...
    const result = await query(
      ...
      [team_name, member1_name, member1_student_id, member2_name, member2_student_id, message || "", photo_url || ""]
    );
